...
public:
    ...
    void setupUi(QMainWindow *Logon)
    {
        ...
        logpushButton->setObjectName("logpushButton");

        horizontalLayout->addWidget(logpushButton);

        signpushButton = new QPushButton(layoutWidget);
        signpushButton->setObjectName("signpushButton");

        horizontalLayout->addWidget(signpushButton);
    ...
    void retranslateUi(QMainWindow *Logon)
    {
        ...
        logpushButton->setText(QCoreApplication::translate("Logon", "\347\231\273\345\275\225", nullptr));
        signpushButton->setText(QCoreApplication::translate("Logon", "\346\263\250\345\206\214", nullptr));
    } // retranslateUi
